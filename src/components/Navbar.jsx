    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "nav-scrolled" : ""}`}>
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        <div className="nav-shell">
          <a href="/#home" className="nav-brand" onClick={() => setOpen(false)} aria-label="JECRC Student Council home">
            <div className="nav-logo-lockup nav-logo-jecrc" aria-label="JECRC logo">
              <div className="nav-logo-mark">
                <img src={img("logos/jecrc-attached.png")} alt="JECRC logo" />
              </div>
            </div>
          </a>
          ...
          <div className="nav-actions">
            ...
            <div className="nav-logo-lockup nav-logo-sdc" aria-label="Student Council logo">
              <div className="nav-logo-mark">
                <img src={img("logos/logoss-02.png")} alt="Student Council" />
              </div>
            </div>
