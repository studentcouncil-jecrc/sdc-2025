...
const clubMeta = {
  ...
  soch: { eyebrow: "Awareness / Impact", manifesto: "Think it. Then do something about it.", focus: ["Awareness campaigns", "Community drives", "Sustainability"], gallery: ["parichay", "navrang", "laFiesta"] },
  suhasini: { eyebrow: "Social / Empowerment", manifesto: "Rise, shine, and make space for others.", focus: ["Girl empowerment", "Education", "Safety & awareness"], gallery: ["parichay", "freshers", "laFiesta"] },
  aashayein: { eyebrow: "Social / Service", manifesto: "Small acts can carry a lot of hope.", focus: ["Blood donation", "Check-up camps", "Community service"], gallery: ["parichay", "freshers", "annualFest"] },
  zarurat: { eyebrow: "Social / Education", manifesto: "Give a dream the chance to become a future.", focus: ["Education support", "Child welfare", "Community outreach"], gallery: ["parichay", "navrang", "annualFest"] },
